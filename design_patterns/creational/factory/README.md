...
The creational.factory design pattern is used when we have a superclass with multiple sub-classes based on input, we need to return one of the sub-class. This pattern takes out the responsibility of a class from the client program to the creational.factory class.
